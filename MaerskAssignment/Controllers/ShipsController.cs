...
namespace MaerskAssignment.Controllers
{
    public class ShipsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ShipID,ShipName,ShipType,TotalContainers")] Ship ship)
        {
        ...
        public ActionResult Edit([Bind(Include = "ShipID,ShipName,ShipType,TotalContainers")] Ship ship)
        {
            if (ModelState.IsValid)
            {
